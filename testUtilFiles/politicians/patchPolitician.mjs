//testUtilFiles/politicians/patchPolitician.mjs
...
// 🛠️ Only the fields you want to update
const updates = {
  committee_assignments: ["Wine", "Women", "Song"],
};
...
try {
  ...
  if (response.ok) {
    console.log("✅ Politician successfully updated:\n");
    ...
    if (response.status === 401) {
      ...
      console.error("⚠️ Bad Request — Invalid update payload.");
    }
    if (data?.error) {
